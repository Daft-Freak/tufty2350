...
if (EXISTS "${PIMORONI_TOOLS_DIR}/ffsmake/build/ffsmake" AND EXISTS "${PIMORONI_FATFS_DIR}")
    ...
    add_custom_target("${MICROPY_TARGET}-fatfs.bin" ALL
        COMMAND "${PIMORONI_TOOLS_DIR}/ffsmake/build/ffsmake" --sector-count=1024 --force --directory "${PIMORONI_FATFS_DIR}" --output "${CMAKE_BINARY_DIR}/${MICROPY_TARGET}-fatfs.bin"
        WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR}
